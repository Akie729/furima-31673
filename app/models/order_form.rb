class OderForm
  ...
  def save
    ...
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, house_number: house_number,:building_name: building_name, phone: phone, order: order.id)
  end
end